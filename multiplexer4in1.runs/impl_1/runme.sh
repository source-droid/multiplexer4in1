...
HD_PWD='C:/Users/031-17-0027/Desktop/Encoder/multiplexer4in1/multiplexer4in1.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log multiplexer_4_in_1.vdi -applog -m64 -messageDb vivado.pb -mode batch -source multiplexer_4_in_1.tcl -notrace
