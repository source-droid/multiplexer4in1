...
HD_PWD='C:/Users/031-17-0027/Desktop/Encoder/multiplexer4in1/multiplexer4in1.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log multiplexer_4_in_1.vds -m64 -mode batch -messageDb vivado.pb -notrace -source multiplexer_4_in_1.tcl
